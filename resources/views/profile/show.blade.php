...
<div id="rpgram-custom-profile" style="background-color: #000; color: #fff; min-height: 100vh; font-family: -apple-system, BlinkMacSystemFont, sans-serif;">
    ...
    <!-- 1. BARRA SUPERIOR (Username @ no topo conforme solicitado) -->
    ...
    <!-- 2. CABEÇALHO (Avatar, Stats, Nome e Bio) -->
    ...
    <!-- 3. LINHA DE DESTAQUES (Botão Novo + Listagem Segura) -->
    ...
    <!-- 4. ESQUELETO DO MODAL (Câmera + Nome + Salvar) -->
...
<script>
    ...
    document.getElementById('saveHighlightBtn').onclick = function() {
        ...
        alert('Processando envio para o S3 (rpgram-media): ' + name);
    };
</script>
